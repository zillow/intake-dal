...
latex_documents = [
  ('index', 'intake-dal.tex', 'intake-dal Documentation',
   'aiplat@zillow.com', 'manual'),
]
...
man_pages = [
    ('index', 'intake-dal', 'intake-dal Documentation',
     ['aiplat@zillow.com'], 1)
]
...
texinfo_documents = [
  ('index', 'intake-dal', 'intake-dal Documentation',
   '', 'intake-dal', 'One line description of project.',
   'Miscellaneous'),
]
